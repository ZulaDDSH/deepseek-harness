...
export const en = {
  ...
  jevEnabled: 'Enable Jev routing',
  jevApiKeyEnv: 'Jev API key environment name',
  jevEndpoint: 'Jev endpoint',
  jevModel: 'Jev model',
  jevTimeoutMs: 'Jev timeout (ms)',
  jevMinConfidence: 'Minimum confidence',
  jevStateMaxChars: 'Maximum state characters',
  jevFallback: 'Fallback route',
  jevFailOpen: 'Keep the request when Jev fails',
  jevRoutes: 'Routing routes',
  jevRouteId: 'Route ID',
  jevRouteProvider: 'Route provider',
  jevRouteModel: 'Route model',
  ...
  signInDescription: 'Continue in your browser to finish signing in. This window updates on its own.',
  ...
  signInAnswerFailed: 'That answer was refused: {message}',
  signedIn: 'Signed in',
  signedOut: 'Not signed in',
  signInOpenPage: 'Open this page',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  jevMinConfidence: '\u6700\u4f4e\u7f6e\u4fe1\u5ea6',
  jevStateMaxChars: '\u72b6\u6001\u6700\u5927\u5b57\u7b26\u6570',
  jevFallback: '\u56de\u9000\u8def\u7531',
  jevFailOpen: 'Jev \u5931\u8d25\u65f6\u4fdd\u7559\u8bf7\u6c42',
  jevRoutes: '\u8def\u7531\u89c4\u5219',
  jevRouteId: '\u8def\u7531 ID',
  jevRouteProvider: '\u8def\u7531\u63d0\u4f9b\u65b9',
  jevRouteModel: '\u8def\u7531\u6a21\u578b',
  ...
  signInDescription: '请在浏览器中完成登录，此窗口会自动更新。',
  signingIn: '等待登录…',
  signInCancel: '取消',
  signInRetry: '重试',
  signInFailed: '登录失败：{message}',
  signInCancelled: '登录已取消。',
  signInAnswerFailed: '该回答被拒绝：{message}',
  signedIn: '已登录',
  signedOut: '未登录',
  signInOpenPage: '打开此页面',
  signInSubmit: '继续',
}
