...
export const zh = {
  ...
  'source.title': '更改',
  'source.subtitle': '查看当前工作区的 Git 更改',
  'source.changed': '已更改 {count} 个文件',
  'source.workspace': '工作区',
  'source.files': '更改的文件',
  'source.refresh': '刷新更改',
  'source.loading': '正在读取工作区更改…',
  'source.error': '无法读取工作区更改',
  'source.noWorkspace': '没有可用的工作区',
  'source.noRepository': '此工作区不是 Git 仓库',
  'source.clean': '没有更改',
  'source.selectFile': '选择文件以查看更改',
...
export const en: Record<DeliverablesKey, string> = {
  ...
  'source.subtitle': 'Review the current Git working tree',
  'source.changed': 'Changed: {count}',
  'source.workspace': 'Workspace',
  'source.files': 'Changed files',
  'source.refresh': 'Refresh changes',
  'source.loading': 'Reading workspace changes…',
  'source.error': 'Could not read workspace changes',
  'source.noWorkspace': 'No workspace is available',
  'source.noRepository': 'This workspace is not a Git repository',
  'source.clean': 'No changes',
  'source.selectFile': 'Select a file to review its changes',
