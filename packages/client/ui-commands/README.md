...
- **Argument-requiring commands stay out of the root quick switcher** — the switcher never mutates an unsent composer draft, so commands that need arguments remain available through the slash-command surface.
