...
describe('product icon set', () => {
  it('exports regular and medium variants for all 103 public glyphs', () => {
    expect(iconNames.length).toBe(206)
    ...
    expect(iconNames).toEqual(expect.arrayContaining([
      ...
      'IconFolderOutlineMedium', 'IconWorkspaceDatabaseOutlineMedium',
    ]))
  })
