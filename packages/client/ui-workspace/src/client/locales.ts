...
export const zh = {
  ...
  'activity.completed': '最近完成',
  'activity.empty': '暂无活动',
  'quick.title': '快速切换',
  'quick.placeholder': '搜索会话、工作区和命令…',
  'quick.sessions': '会话',
  'quick.workspaces': '工作区',
  'quick.commands': '命令',
  'quick.empty': '没有匹配项',
  'quick.loading': '正在加载命令…',
  'quick.navigate': '导航',
  'quick.open': '打开',
  'orderBy.label': '排序方式',
  'orderBy.manual': '手动排序',
...
export const en = {
  ...
  'groupBy.sections': 'Sections',
  'activity.attention': 'Needs attention',
  'activity.running': 'Running',
  'activity.completed': 'Recently completed',
  'activity.empty': 'No active work',
  'quick.title': 'Quick switcher',
  'quick.placeholder': 'Search sessions, workspaces, and commands…',
  'quick.sessions': 'Sessions',
  'quick.workspaces': 'Workspaces',
  'quick.commands': 'Commands',
  'quick.empty': 'No matches',
  'quick.loading': 'Loading commands…',
