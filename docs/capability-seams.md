...
| `ctx.authorizationController` | `core` | [`api-settings-controller`](../packages/api/settings-controller) | - | - | - | Projects authorization discovery, attempt streaming, prompt answers, and cancellation onto the generated Remote namespace. |
